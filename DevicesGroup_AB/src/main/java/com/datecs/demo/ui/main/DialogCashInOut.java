...
public class DialogCashInOut extends Dialog implements
        ...
        switch (v.getId()) {
            ...
            case R.id.btn_set_cio_OK:
                ...
                try {
                    ...
                    CashINOUT(String.format("%.2f", newAmount));
                } catch (Exception e) {
    ...
    private void CashINOUT(String valueOfCurrency) {
        try {
            ...
            cashInSafe = new cmdReceipt.FiscalReceipt().cashInCashOut(Double.valueOf(valueOfCurrency));
            AlertDialog.Builder builder1 = new AlertDialog.Builder(getContext());
            builder1.setMessage("Cash in safe:" + cashInSafe[0] + "\n\r" +
                    " Sum of Cash IN:" + cashInSafe[1] + "\n\r" +
                    " Sum of Cash OUT:" + cashInSafe[2]);
            builder1.setCancelable(false);
            builder1.setPositiveButton(R.string.okButtonText, new OnClickListener() {
